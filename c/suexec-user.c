 ...
 *
 * User version. Each user who is allowed to run CGI programs should have
 * a copy of this in the suexecdir which is setuid and setgid to that user's
 * uid and group.
 *
...
int main(int argc, char *argv[])
{
    ...
    /* This fails on the legitimate case of a symbolic link
     * to the directory from elsewhere. Let the user decide.
     */
     ...
     * Stat the cwd and verify it is a directory, or error out.
     */
    validate_dirfilestat (cmd,&dir_info,&prg_info,uid,gid,cwd,pfn);
